...
null
*/
public class ApplicationControlFormActions {

	private ApplicationControlFormController controller;

	public ApplicationActionList getActions(ApplicationControlFormController c) {
 	controller = c;
